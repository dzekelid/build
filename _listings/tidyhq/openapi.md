...
paths:
  ...
  /buildingblocks/{building_block_id}/tools/:
    ...
    post:
      ...
      x-api-path-slug: buildingblocksbuilding-block-idtools-post
      parameters:
      - in: formData
        name: appid
        description: your appid for accessing the building block
  ...
  /buildingblocks/{building_block_id}/tools/{tool_id}:
    delete:
      ...
      x-api-path-slug: buildingblocksbuilding-block-idtoolstool-id-delete
      parameters:
      - in: query
        name: appid
        description: your appid for accessing the building block
  ...
  /buildingblocks/{building_block_id}/urls/:
    get:
      ...
      x-api-path-slug: buildingblocksbuilding-block-idurls-get
      parameters:
      - in: query
        name: appid
        description: your appid for accessing the building block
    ...
    post:
      ...
      x-api-path-slug: buildingblocksbuilding-block-idurls-post
      parameters:
      - in: formData
        name: appid
        description: your appid for accessing the building block
  ...
  /buildingblocks/{building_block_id}/urls/{url_id}:
    delete:
      ...
      x-api-path-slug: buildingblocksbuilding-block-idurlsurl-id-delete
      parameters:
      - in: query
        name: appid
        description: your appid for accessing the building block
